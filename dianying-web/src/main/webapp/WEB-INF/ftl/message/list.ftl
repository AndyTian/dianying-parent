...
<div id="page-content-wrapper">
            ...
            <tr >
                <td>
                    <#list userList as user>
                        <#if user.id == "${message.userId!''}">${user.name!''}</#if>
                    </#list>
                </td>
                <td>
                    ${message.content}
                ...
                <td class="center">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu float-right">
                            <li>
                                <a href="javascript:;" title="" onclick="initUpdate(${message.id});">
                                    <i class="glyph-icon icon-edit mrg5R"></i>
                                    修改
                                </a>
                                <a href="javascript:;" title="" onclick="initDelete(${message.id});">
    ...
    <script type="text/javascript">
        ...
        function initUpdate(id){
            $.get( "/message/showUpdate/" + id, function( data ){
                ...
                $( html ).dialog({
                    ...
                    buttons: {
                        提交: function() {
                            ...
                            $.post( '/message/update/' + id, $( '#dialog form' ).serialize() )
                                    .done(function(data){
        ...
        function initAdd(){
            $.get( "/message/showAdd", function( data ){
                ...
                $( html ).dialog({
                    ...
                    buttons: {
                        提交: function() {
                            ...
                            $.post( '/message/add', $( '#dialog form' ).serialize() )
                                    .done(function(data){
                                        if(data["status"] == "success"){
